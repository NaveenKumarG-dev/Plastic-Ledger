...
Usage:
    python run_balanced_training_workflow.py \
        --src_data D:/Plastic-Ledger/ml_training/dataset/MARIDA \
        --balanced_data D:/Plastic-Ledger/ml_training/dataset/MARIDA_BALANCED \
...
def main():
    ...
    print(f"{'='*80}\n")
    print(f"Next steps:")
    print(f"  1. Evaluate the model: python ml_training/unet/marida_evaluate.py \\")
    ...
    print(f"\n  2. Compare with previous models using ml_training/evaluation/evaluate_models.py")
    print()
